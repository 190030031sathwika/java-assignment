...
public class Hostelite2 extends Student2{
	...
	public Hostelite2(int studentId, char studentType, String name, double feesPerMonth, String hostelName, int roomNumber) {
	...
	public static void main(String[] args) {
		Hostelite2 obj = new Hostelite2(1, 'A', "Rakshit", 1000, "ABC", 123);
